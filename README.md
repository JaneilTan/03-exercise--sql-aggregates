# 03 Exercise - SQL Aggregates

Calculate some values using SQL aggregate functions.
...
```shell
docker run -d \
  --name sql-aggregates-db \
  -p 5432:5432 \
  -e POSTGRES_PASSWORD=password \
  -v sql-aggregates-db:/var/lib/postgresql/data \
...
1-count.sql    # your SQL query
1-count.json   # your SQL query results in JSON format
```
...
## Instructions Part A - Aggregate Queries
